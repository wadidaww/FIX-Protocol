...
struct FixErrorCategory : std::error_category {
    ...
    std::string message(int ev) const override {
        ...
        case ErrorCode::StoreError:
            return "store error";
        case ErrorCode::DictionaryError:
        ...
        case ErrorCode::UnsupportedVersion:
            return "unsupported FIX version";
        ...
        case ErrorCode::UnknownMessage:
            return "unknown message type";
        case ErrorCode::RejectCode:
            return "message rejected";
        default:
            return "unknown fix error";
        }
    }
};
...
constexpr std::string_view to_string(FixVersion v) noexcept {
    switch (v) {
    case FixVersion::FIX_4_0:
        return "FIX.4.0";
    case FixVersion::FIX_4_1:
        return "FIX.4.1";
    case FixVersion::FIX_4_2:
        return "FIX.4.2";
    case FixVersion::FIX_4_3:
        return "FIX.4.3";
    case FixVersion::FIX_4_4:
        return "FIX.4.4";
    case FixVersion::FIX_5_0:
        return "FIX.5.0";
    case FixVersion::FIX_5_0SP1:
        return "FIX.5.0SP1";
...
inline FixVersion parse_version(std::string_view sv) noexcept {
    if (sv == "FIX.4.0")
        return FixVersion::FIX_4_0;
    if (sv == "FIX.4.1")
        return FixVersion::FIX_4_1;
    if (sv == "FIX.4.2")
...
struct SessionID {
    ...
    bool operator==(const SessionID &o) const noexcept {
        return version == o.version && senderCompID == o.senderCompID &&
               targetCompID == o.targetCompID && qualifier == o.qualifier;
    }
